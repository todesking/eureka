...
await scrape({ name: 'ユリイカ', catId: 10, filter: 'ユリイカ', years: [1988, 2026], out: 'data/eureka.json' })
await scrape({ name: '現代思想', catId: 11, filter: '現代思想', years: [1973, 2026], out: 'data/gendai_shiso.json' })
